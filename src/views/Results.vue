  ...
  <div class="Results">
    ...
    <v-container>
        ...
        <div v-if="loaded">
            ...
            <center>
                <div v-if="passed < tests.length" style="display: inline-block; border: min(1vmin, 5px) solid black; padding: 2px">
                    <center class="text-h6">Consider calling these hotlines</center>

                    <div class=ma-1 style="font-size: .95rem; text-align:left">
